export default class CI_vPersonasBootstrap {
    lblPromedio;
    lblEdadesPersonas;
    lblMayorMenor;
    lblComparacion;
    ...
    reportar({ persona, personas }) {
        ...
        this.lblEdadesPersonas.innerHTML = ` Análisis por categorías (mayores/menores de edad)
                                            <br>
                                            porcentaje de menores: ${personas.porcentajeMenores()}% (${personas.cantidadMenores()} personas)
                                            <br> 
                                            porcentaje de mayores: ${personas.porcentajeMayores()}% (${personas.cantidadMayores()} personas)`;
...
//# sourceMappingURL=CI_vPersonasBootstrap.js.map